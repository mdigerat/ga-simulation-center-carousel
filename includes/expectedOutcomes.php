...
<div class="content formBorder">
    ...
    <strong>Class "Planning for Successful Outcomes" Information</strong>
...
<div class="row">
  <div class="col-md-12">
    <div class="form-group">           
            <div class="checkbox">
              <label>
                ...
                <strong><em>Expected Outcomes</em></strong>
              </label>
            </div>
    ...
    <div class="formBorder">
            <div class="row">
                <div class="col-md-8">
                  <strong><u>Planning for Successful Outcomes</u></strong>
                    <div class="form-group">
